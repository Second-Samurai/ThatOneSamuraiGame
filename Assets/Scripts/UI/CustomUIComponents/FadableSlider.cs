...
public class FadableSlider : Slider
{
    ...
    public void FadeOutAndInvoke(Action callback)
    {
        this.m_IsFadingIn = false;
        this.StartCoroutine(this.AnimateFade(FadeDirection.Out, 0.8f, callback));
    }
    
    private IEnumerator AnimateFade(FadeDirection fadeDirection, float fadeTime, Action callback = null)
    {
